...
## How to download the program?
   ...
   All files necessary to run the program can be downloaded into the user´s computer by simply clicking the **Clone or Code or Download** button and then the **Download ZIP**.\
  The program can also be obtained free of charge by email from the authors Renan B. Lemes (renan.barbosa.lemes@gmail.com) or Paulo A. Otto (otto@usp.br).\
